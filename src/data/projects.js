...
const data = [
  {
    ...
    date: '2021-09-25',
    desc:
      'Layout based Deep neural network to extract intelligent information from invoice documents for the predefined labels. It is done by finetuning LayoumLMv2 model. Postprocessing is done using the K-Means Clustering to eliminate outliers. Final F1 Score of 0.81 with 22 labels',
